...
fun CustomReadOnlyField(
    ...
    Column(
        modifier = modifier,
        verticalArrangement = Arrangement.spacedBy(Dimens.ExtraExtraSmallMargin)
    ) {
        Text(text = title, style = BodyPopBold, modifier = modifier.fillMaxWidth())
        ...
        Surface(
            ...
            shadowElevation = Dimens.ExtraExtraSmallMargin,
